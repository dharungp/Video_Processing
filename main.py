...
# Code for Project 265 Grayscale start here
    ...
    result =cv2.VideoWrite('static/' + 'blackandwhite.mp4',cv2.VideoWriter_fourcc(30,size,0))
    try:
        while : True
...
@app.route('/download')
def download_file():
    concerted_video_path = "static/blackandwhite.mp4"
    return send_file(concerted_video_path , as_attachment=True)
